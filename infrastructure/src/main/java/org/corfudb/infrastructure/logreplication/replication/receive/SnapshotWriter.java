...
public interface SnapshotWriter {
    ...
    void apply(LogReplication.LogReplicationEntryMsg message) throws Exception;

    void apply(List<LogReplication.LogReplicationEntryMsg> messages) throws Exception;
}
