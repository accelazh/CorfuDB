...
public class StreamsSnapshotWriter implements SnapshotWriter {
     ...
     */
    @Override
    public void apply(LogReplication.LogReplicationEntryMsg message) {
    ...
    @Override
    public void apply(List<LogReplication.LogReplicationEntryMsg> messages) {
        for (LogReplication.LogReplicationEntryMsg msg : messages) {
            apply(msg);
        }
    }
